...
exports.getAdd = (req, res) => {
  let ejsContent = fs.readFileSync(
    path.join(__dirname, "..", "views/add.ejs"),
    "utf-8"
  );
  let htmlRenderized = ejs.render(ejsContent, {
    filename: "views/add.ejs",
...
exports.postAdd = (req, res) => {
  ...
  form.parse(req, function (err, fields, files) {
    let camp = new Camp(
      ...
      fields.end_date,
      fields.description,
      path.extname(files.imagini.name).toString(),
      fields.address,
      fields.city,
      false
    )
      ...
      .then((result) => {
        ...
        var newPath =
          ...
          path.extname(files.imagini.name);
